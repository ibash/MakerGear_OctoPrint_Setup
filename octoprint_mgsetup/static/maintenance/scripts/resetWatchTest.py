...
def tap():
    ...
    if avrFlag == 0:
        ...
        logText = (
            "Cancel script was activated because the RAMBo reset button  / reset line was tapped at  "
            + dateTimeVal
        )
...
def resetPasswordHold():
    ...
    logText = (
        "System was restored because the RAMBo reset button  / reset line was held for more than 60 seconds at "
        + dateTimeVal
        + " See "
        + logFileName
